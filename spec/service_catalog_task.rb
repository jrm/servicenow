...
describe Servicenow::ServiceCatalogTask do
  ...
  describe ".get_record" do
    it "returns a record" do
      record = Servicenow::ServiceCatalogTask.get_record(:number => "TASK0017579")
      sla = Servicenow::ServiceCatalogTaskSLA.get_record(:sct_number => record.number)
